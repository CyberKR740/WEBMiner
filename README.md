...
<table border="0" cellpadding="2" cellspacing="5" width="100%">
  ...
  <tr>
    <td width="500px" class="main"> <br>wget https://raw.githubusercontent.com/CyberKR740/WEBMiner/refs/heads/master/minergrit.py<br/> <b>chmod +x minergrit.py<b/> <b>python3 minergrit.py<b/><br>Não e preciso utilizar ó screen para deixar em segundo plano, o progama faz isto automaticamente.<b>Para Reabrir o progama apos ter feixado á conexão com o servidor Utilize: screen -r</br><b>Caso o python3 não estiver instalado:</b><b>apt-get install python3</b></td>
  </tr>
</body>
</html>
