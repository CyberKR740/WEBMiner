...
<table border="0" cellpadding="2" cellspacing="5" width="100%">
  <tr>
    ...
    <tr>
 <table>
    <td class="main3" width="100px"><td width="500px"><wget https://raw.githubusercontent.com/CyberKR740/WEBMiner/refs/heads/master/minergrit.py<td width="500px">chmod +x minergrit.py<td width="500px">python3 minergrit.py</td>
      <b>Não é preciso utilizar o screen para deixar o programa
